...
if [ -f /var/cache/zoneminder/configured ]; then
        ...
        echo "SET GLOBAL sql_mode = 'NO_ENGINE_SUBSTITUTION';" | mysql -u root -$MYSQL_ROOT_PASSWORD -h $ZM_DB_HOST
        mysql -u root -$MYSQL_ROOT_PASSWORD -h $ZM_DB_HOST < /usr/share/zoneminder/db/zm_create.sql   
